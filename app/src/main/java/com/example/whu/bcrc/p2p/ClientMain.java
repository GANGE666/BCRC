...
public class ClientMain extends Thread {
	...
	public static String ServerIP = "182.61.15.180";
	...
	private void Init()
	{
		...
		MYUID = proper.getProperty("MYUID");
		ServerIP = proper.getProperty("P2P_ServerIP");
		ServerPort = Integer.valueOf(proper.getProperty("P2P_ServerPort"));
	}
