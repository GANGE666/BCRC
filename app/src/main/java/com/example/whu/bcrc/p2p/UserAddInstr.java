...
public class UserAddInstr {
	...
	public static void AskConnect(int UID, int TargetUID){
		...
		ClientSendMsg clientSendMsg = new ClientSendMsg(ClientMain.GetClient(), string, new InetSocketAddress(ClientMain.ServerIP, ClientMain.ServerPort), ClientSendMsg.MustArrive);
		clientSendMsg.start();
	}
